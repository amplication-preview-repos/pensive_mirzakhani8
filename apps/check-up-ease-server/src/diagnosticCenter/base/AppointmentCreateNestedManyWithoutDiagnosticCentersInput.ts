...
@InputType()
class AppointmentCreateNestedManyWithoutDiagnosticCentersInput {
...
export { AppointmentCreateNestedManyWithoutDiagnosticCentersInput as AppointmentCreateNestedManyWithoutDiagnosticCentersInput };
