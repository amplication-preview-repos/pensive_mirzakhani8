...
@InputType()
class AppointmentUpdateManyWithoutDiagnosticCentersInput {
...
export { AppointmentUpdateManyWithoutDiagnosticCentersInput as AppointmentUpdateManyWithoutDiagnosticCentersInput };
